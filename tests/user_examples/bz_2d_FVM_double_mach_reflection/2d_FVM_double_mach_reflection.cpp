...
int main(int ac, char *av[])
{
    ...
    readMeshFile read_mesh_data(double_mach_reflection_mesh2_fullpath);
    //----------------------------------------------------------------------
    ...
    SimpleDynamics<EulerianCETimeStepInitialization> initialize_a_fluid_step(wave_block);
    ...
    InteractionWithUpdate<CEIntegration1stHalfHLLERiemann> pressure_relaxation(water_block_inner);
    InteractionWithUpdate<CEIntegration2ndHalfHLLERiemann> density_relaxation(water_block_inner);
