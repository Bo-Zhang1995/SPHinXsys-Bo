    ...
    : public fluid_dynamics::FluidInitialCondition
{
  ...
  protected:
    void update(size_t index_particle_i, Real dt)
    {
        ...
        force_prior_[index_particle_i][0] = -1.0 * 1.0 * pos_[index_particle_i][0];
        force_prior_[index_particle_i][1] = -1.0 * 1.0 * pos_[index_particle_i][1];
    }
...
int main(int ac, char *av[])
{
     ...
     */
    InteractionWithUpdate<LinearGradientCorrectionMatrixInner> corrected_configuration_fluid(water_block_inner, 0.3);
    ...
    ReducedQuantityRecording<ReduceDynamics<PotentialEnergy>>
        write_water_potential_energy(water_block);
...
//Real rho0_f = 1000.0;						/**< Reference density of fluid.*/
//Real U_f = 1.0;		                        /**< Characteristic velocity.*/     //2.0*sqrt(gravity_g*LH)
//Real c_f = 10.0 * U_f;					    /**< Reference sound speed.*/       //10.0*U_f
//
////for the circle parameter
//Vec2d Circle_center(0, 0);    //circle center
//Real  Circle_radius = 1.0;    //circle radius 0.1
//
//Real DL = 4 * Circle_radius;  //maximum length
//Real DH = 4 * Circle_radius;  //maximum height
//
//class WaterBlock : public MultiPolygonShape
//{
//public:
...
//{
//public:
//	InitialVelocity(SPHBody& sph_body): fluid_dynamics::FluidInitialCondition(sph_body) {};
//
//	void update(size_t index_particle_i, Real dt)
//	{
//		/** initial velocity profile */
...
//
//		/** A  Physics relaxation step. */
//		relax_dynamics::RelaxationStepLevelSetCorrectionInner relaxation_step_inner(water_block_inner);
//		/**
//		 * @brief 	Particle relaxation starts here.
//		 */
//		random_water_body_particles.exec(0.25);
...
//	 * @brief 	Methods used for time stepping.
//	 */
//    InteractionWithUpdate<LinearGradientCorrectionMatrixInner> corrected_configuration_fluid(water_block_inner, 0.9);
//    Dynamics1Level<fluid_dynamics::Integration1stHalfCorrectionInnerRiemann> fluid_pressure_relaxation(water_block_inner);
//    Dynamics1Level<fluid_dynamics::Integration2ndHalfInnerRiemann> fluid_density_relaxation(water_block_inner);
//	InteractionWithUpdate<fluid_dynamics::DensitySummationFreeSurfaceInner> fluid_density_by_summation(water_block_inner);
//    ReduceDynamics<fluid_dynamics::AdvectionTimeStep> fluid_advection_time_step(water_block, U_f);
