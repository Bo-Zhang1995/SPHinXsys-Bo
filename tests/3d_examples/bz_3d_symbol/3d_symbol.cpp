...
//----------------------------------------------------------------------
Real DL = 4.4; //Domain hight.
Real DH = 4.4; //Domain length.
Real DW = 0.4; //Domain width
Real resolution_ref = DW / 5;
Real BW = 4 * resolution_ref;
Vec3d domain_lower_bound(-2.5 - BW, -0.5 - BW, -0.2 - BW);
Vec3d domain_upper_bound(2.5 + BW, 4.5 + BW, 0.2 + BW);
...
int main(int ac, char *av[])
{
    ...
    imported_model.defineAdaptationRatios(0.8, 1.0);
